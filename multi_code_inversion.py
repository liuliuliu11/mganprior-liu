...
# args.gan_model = stylegan2_ffhq
# python multi_code_inversion.py --gan_model stylegan2_ffhq --target_images ./examples/gan_inversion/ffhq-liu/ --outputs ./gan_inversion_ffhq --inversion_type=StyleGAN-w+ --composing_layer 8 --z_number 20
...
if __name__ == '__main__':
    ...
    parser.add_argument('--optimization', default='SGD',
                        help="['SGD', 'Adam']. Optimization method used.")
